...
BillRecordResponse _$BillRecordResponseFromJson(Map<String, dynamic> json) {
  return BillRecordResponse(
    json['code'] as int,
    (json['data'] as List)
        ?.map((e) => e == null ? null : BillRecordModel.fromJson(e as Map<String, dynamic>))
        ?.toList(),
    json['msg'] as String,
  );
}

Map<String, dynamic> _$BillRecordResponseToJson(BillRecordResponse instance) => <String, dynamic>{
      'code': instance.code,
      'data': instance.data,
      'msg': instance.msg,
    };
...
Map<String, dynamic> _$BillRecordModelToJson(BillRecordModel instance) => <String, dynamic>{
      'id': instance.id,
