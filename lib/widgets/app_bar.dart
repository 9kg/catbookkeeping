...
class MyAppBar extends StatelessWidget implements PreferredSizeWidget {
  const MyAppBar(
      ...
      this.titleWidget,
      this.actionName: "",
      this.backImg: Images.appBackIcon,
      this.onPressed,
      this.isBack: true,
      this.leading,
  ...
  Widget build(BuildContext context) {
    SystemUiOverlayStyle _overlayStyle =
        barStyle == StatusBarStyle.dark ? SystemUiOverlayStyle.dark : SystemUiOverlayStyle.light;
                ...
                children: <Widget>[
                  Container(
                    ...
                    child: titleWidget != null
                        ? DefaultTextStyle(
                            style: TextStyle(
                              color: _overlayStyle == SystemUiOverlayStyle.light ? Colors.white : Colours.dark,
                              fontSize: 17,
                            ),
                            child: titleWidget,
                          )
                      ...
                      ? CupertinoButton(
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              Image.asset(
                                backImg,
                                color: _overlayStyle == SystemUiOverlayStyle.light ? Colors.white : Colours.app_main,
                              ),
                ...
                child: Theme(
                  ...
                  child: actionName.isEmpty
                      ...
                      : FlatButton(
                          ...
                          textColor: _overlayStyle == SystemUiOverlayStyle.light ? Colors.white : Colours.dark,
