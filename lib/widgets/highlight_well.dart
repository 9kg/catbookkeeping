...
class _HighLightWellState extends State<HighLightWell> with SingleTickerProviderStateMixin {
          ...
          builder: (BuildContext context, Widget child) {
            return Container(
              foregroundDecoration: BoxDecoration(
                  color: widget.isForeground ? isDown ? widget.highColor.withOpacity(0.5) : Colors.transparent : null,
                  shape: BoxShape.rectangle,
                  borderRadius: widget.borderRadius),
              decoration: BoxDecoration(
                  color: widget.isPressingEffect ? widget.highColor.withOpacity(0.5 * _controller.value) : null,
                  shape: BoxShape.rectangle,
                  borderRadius: widget.borderRadius),
              child: widget.child,
            );
