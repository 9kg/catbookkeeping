...
class ChartState extends State<StatefulWidget> with AutomaticKeepAliveClientMixin {
  @override
  //保存状态
  ...
  Future<void> _initData() async {
    ...
    dbHelp.getBillList(startTime, endTime).then((list) {
      ...
      map.keys.forEach((key) {
        ...
        double ratio = money / (_type == 1 ? _monthExpenMoney : _monthIncomeMoney);
        ChartItemModel itemModel = ChartItemModel(index, key, image, money, ratio, items.length);
                ...
                return Column(children: <Widget>[
                  ...
                  Container(
                    ...
                    child: OverflowBox(
                        ...
                        child: charts.PieChart(_type == 1 ? _expendChartDatas : _incomeChartDatas,
                            animate: true,
        ...
        children: <Widget>[
          ...
          ButtonTheme(
            ...
            child: FlatButton(
              child: Text(
                '$_year-$_month',
                style: TextStyle(fontSize: ScreenUtil.getInstance().setSp(34), color: Colours.app_main),
              ),
              onPressed: () {
                showDialog(
                  context: context,
          ...
          children: <Widget>[
            ...
            Column(
              ...
              children: <Widget>[
                Text(
                  model.categoryName,
                  style: TextStyle(fontSize: ScreenUtil.getInstance().setSp(32), color: Colours.dark),
                ),
                Text(
            ...
            Expanded(
              ...
              child: Text(
                ...
                maxLines: 1,
                style: TextStyle(fontSize: ScreenUtil.getInstance().setSp(36), color: Colors.black),
              ),
            ),
          ],
        ),
...
class ChartItemModel {
  ...
  ChartItemModel(this.id, this.categoryName, this.image, this.money, this.ratio, this.number);
}
